classdef activation_torchmangle1315_ReLU < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %activation_torchmangle1315_ReLU Auto-generated custom layer
    ...
    methods
        function obj = activation_torchmangle1315_ReLU(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
