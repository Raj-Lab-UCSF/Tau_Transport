classdef activation_torchmangle13_ReLU < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %activation_torchmangle13_ReLU Auto-generated custom layer
    ...
    methods
        function obj = activation_torchmangle13_ReLU(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [relu_3] = predict(obj,relu_argument1_1)
            ...
            [relu_argument1_1, relu_argument1_1_format] = nn_model_w_e5.ops.permuteToReversePyTorch(relu_argument1_1, '', 2);
