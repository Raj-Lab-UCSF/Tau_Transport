...
simstr = 'test_timescale_3b'; % for saving the outputs
...
T = []; % default = 0.05
dt = []; % default = 0.005
trange = [0:0.01:0.1, 0.125:0.025:0.2, 0.25:0.05:0.5];
