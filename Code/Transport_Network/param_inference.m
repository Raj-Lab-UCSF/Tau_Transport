function [] = param_inference(sim_num, rep_num)
...
loss_fun = @(x)NTM_Loss(matdir, net_f, net_w, init_path_emp_sim, N_emp_sim, x(1), x(2), x(3), x(4));
...
xmin = fminsearchbnd(loss_fun,x0,[5e-5,0.01,10,10],[5e-2,0.1,100,100]);
...
savepath = strcat('/Users/nbarron/Desktop/output_',sim_num_str,'_',rep_num_str,'.mat');
