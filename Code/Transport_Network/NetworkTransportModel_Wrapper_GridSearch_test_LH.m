...
simstr = 'test_LH'; % for saving the outputs
...
inputparams{2,7} = [0,100]; % delta
inputparams{2,8} = [0,100]; % epsilon
...
T = []; % default = 0.05
dt = []; % default = 0.005
trange = [0:0.01:0.1, 0.12:0.02:0.3, 0.35:0.03:0.65, 0.7:0.05:1];
