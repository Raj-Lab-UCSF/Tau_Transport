classdef linear_torchmangle26_Linear < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %linear_torchmangle26_Linear Auto-generated custom layer
    % Auto-generated by MATLAB on 18-Feb-2025 20:07:53
    ...
    methods
        function obj = linear_torchmangle26_Linear(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [linear_9] = predict(obj,linear_x_1)
            ...
            nn_model_f_wide.ops.validateInput(linear_x_1,2);
            [linear_x_1, linear_x_1_format] = nn_model_f_wide.ops.permuteInputToReversePyTorch(linear_x_1, 2);
        ...
        function [linear_9] = tracedPyTorchFunction(obj,linear_x_1,isForward,predict)
            ...
            [linear_9] = nn_model_f_wide.ops.pyLinear(linear_x_1, GetAttr_weight_1, GetAttr_bias_1);
        end
