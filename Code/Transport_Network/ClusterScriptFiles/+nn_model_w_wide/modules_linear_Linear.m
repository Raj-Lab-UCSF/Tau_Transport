classdef modules_linear_Linear < nnet.layer.Layer & nnet.layer.Formattable & ...
    ...
    methods
        ...
        function [linear_9] = predict(obj,linear_x_1)
            ...
            nn_model_w_wide.ops.validateInput(linear_x_1,2);
            [linear_x_1, linear_x_1_format] = nn_model_w_wide.ops.permuteInputToReversePyTorch(linear_x_1, 2);
        ...
        function [linear_9] = tracedPyTorchFunction(obj,linear_x_1,isForward,predict)
            ...
            [linear_9] = nn_model_w_wide.ops.pyLinear(linear_x_1, GetAttr_weight_1, GetAttr_bias_1);
        end
