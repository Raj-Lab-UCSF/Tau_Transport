...
simstr = 'ca1_ret_debug_with_sr_newW1'; % for saving the outputs
use_W1code = 1;
use_sr = 1;
...
T = []; % default = 0.05
dt = []; % default = 0.005
trange = [0:0.01:0.05]; % LH debug test
...
for i = 1:size(paramgrid,1)
    ...
    if ~use_W1code
        mdloutput = NetworkTransportModel_240802(loadpath,paramnames_i{1},paramlist(1),...
