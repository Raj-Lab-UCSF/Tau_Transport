...
simstr = 'ECl_seed_dir_10_outstruct'; % for saving the outputs
...
inputparams{2,1} = 1e-5; % beta
inputparams{2,2} = 5e-4; % gamma1
inputparams{2,3} = 0; % gamma2
inputparams{2,4} = 0.92; % frac
inputparams{2,5} = 0.1; % lambda1
inputparams{2,6} = 0.1; % lambda2
inputparams{2,7} = [5 10 50 100]; % delta
inputparams{2,8} = [5 10 50 100]; % epsilon
