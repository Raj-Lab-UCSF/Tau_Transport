...
simstr = 'hippocampome_higherT_1'; % for saving the outputs
...
inputparams{2,2} = [5e-4,1e-3,5e-3,1e-2]; % gamma1
...
T = []; % default = 0.05
dt = []; % default = 0.005
trange = [0:0.01:0.1, 0.12:0.02:0.3, 0.35:0.03:0.5, 0.55:0.05:1];
