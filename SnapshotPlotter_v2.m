function SnapshotPlotter_v2(matstr,customt,savenclose,fpath,outpath)
...
if nargin < 5
    outpath = '/Users/justintorok/Documents/MATLAB/Tau_Transport/OutputFigures';
    if nargin < 4
        fpath = '/Users/justintorok/Documents/MATLAB/Tau_Transport/SimResults';
        if nargin < 3
            savenclose = 0;
        end
    end
