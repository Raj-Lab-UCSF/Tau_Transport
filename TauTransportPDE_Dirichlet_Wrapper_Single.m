...
[n, m, xmesh, trange, jn, jm] = TauTransportPDE_Dirichlet('alpha', alpha,...
                                ...
                                'L_ais', L_ais,...
                                'L_syn', L_syn,...
                                'Bn_l', Bn_l*rescale_factor,...
                                'Bn_r', Bn_r*rescale_factor,...
                                'Bm_l', Bm_l*rescale_factor,...
                                'Bm_r', Bm_r*rescale_factor);
...
SnapshotPlotter(simstr,[1,100,145,188,250],1,'/Users/justintorok/Documents/MATLAB/Tau_Transport');
