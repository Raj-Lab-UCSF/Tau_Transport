classdef linear_torchmangle124_Linear < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %linear_torchmangle124_Linear Auto-generated custom layer
    % Auto-generated by MATLAB on 07-Nov-2025 13:45:21
    ...
    methods
        function obj = linear_torchmangle124_Linear(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [linear_input_1] = predict(obj,linear_argument1_1)
            ...
            [linear_argument1_1, linear_argument1_1_format] = nn_model_f_e5.ops.permuteToReversePyTorch(linear_argument1_1, '', 2);
        ...
        function [linear_input_1] = tracedPyTorchFunction(obj,linear_argument1_1,isForward,predict)
            ...
            [linear_input_1] = nn_model_f_e5.ops.pyLinear(linear_argument1_1, GetAttr_weight_1, GetAttr_bias_1);
        end
