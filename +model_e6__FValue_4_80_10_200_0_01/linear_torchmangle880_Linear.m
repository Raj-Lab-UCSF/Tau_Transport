classdef linear_torchmangle880_Linear < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %linear_torchmangle880_Linear Auto-generated custom layer
    ...
    methods
        function obj = linear_torchmangle880_Linear(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [linear_input_1] = predict(obj,linear_argument1_1)
            ...
            [linear_argument1_1, linear_argument1_1_format] = model_e6__FValue_4_80_10_200_0_01.ops.permuteToReversePyTorch(linear_argument1_1, '', 2);
        ...
        function [linear_input_1] = tracedPyTorchFunction(obj,linear_argument1_1,isForward,predict)
            ...
            [linear_input_1] = model_e6__FValue_4_80_10_200_0_01.ops.pyLinear(linear_argument1_1, GetAttr_weight_1, GetAttr_bias_1);
        end
