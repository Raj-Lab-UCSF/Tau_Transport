classdef linear_torchmangle876_Linear < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %linear_torchmangle876_Linear Auto-generated custom layer
    ...
    methods
        function obj = linear_torchmangle876_Linear(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [linear_9] = predict(obj,linear_x_1)
            ...
            model_e6__FValue_4_80_10_200_0_01.ops.validateInput(linear_x_1,2);
            [linear_x_1, linear_x_1_format] = model_e6__FValue_4_80_10_200_0_01.ops.permuteInputToReversePyTorch(linear_x_1, 2);
        ...
        function [linear_9] = tracedPyTorchFunction(obj,linear_x_1,isForward,predict)
            ...
            [linear_9] = model_e6__FValue_4_80_10_200_0_01.ops.pyLinear(linear_x_1, GetAttr_weight_1, GetAttr_bias_1);
        end
